...
import { adminTransactions } from "@/lib/constant";
...
const AdminTransactionTable = () => {
  ...
  const totalPages = Math.ceil(adminTransactions.length / ITEMS_PER_PAGE);

  // Calculate paginated data
  const paginatedInvestments = adminTransactions.slice(
