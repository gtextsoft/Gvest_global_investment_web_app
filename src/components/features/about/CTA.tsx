...
const CTA = () => {
  return (
    <section className="max-w-[1400px] px-5 md:px-16 mx-auto py-32 bg-white">
      <div className="flex flex-col md:flex-row gap-10 md:gap-20 md:items-center justify-center py-10 px-5 md:p-10 bg-lonestar-100 rounded-2xl">
        ...
        <Button
          className="w-fit h-fit md:min-w-fit py-2 px-4 text-lg font-medium"
          variant="default"
        >
         Invest Now
        </Button>
